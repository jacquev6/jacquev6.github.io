...
$(function() {
    // Inspired by https://stackoverflow.com/a/15069289/905845
    var jacquev6_ribbon = $('script[src$=ribbon\\.1\\.js]');

    $("head").append('<link rel="stylesheet" type="text/css" href="{{ site.url }}/ribbon.1.css">');

    var github = jacquev6_ribbon.data("github");
    var project_link = '<p class="jacquev6_ribbon_hidden">hidden</p>';
    if(typeof github != "undefined") {
        project_link = '<p><a href="https://github.com/jacquev6/' + github + '">Fork me on GitHub</a></p>';
    };

    var container = jacquev6_ribbon.data("container");
